...
function setupSheets() {
  ...
  var schemas = [
    {
      name: SHEET_RECEIVED,
      headers: ['タイムスタンプ', 'LINEユーザーID', 'ドライバー名', '年月', 'ファイル種別', 'DriveファイルID', 'DriveURL', 'ステータス', 'OCR実行日時', '同意', '同意日時']
    },
    {
      name: SHEET_OCR,
      headers: ['LINEユーザーID', 'ドライバー名', '年月', '日', '開始時間', '終了時間', '稼働フラグ', '立替経費フラグ', '備考フラグ', '確認ステータス', '修正後開始時間', '修正後終了時間', '受信ファイルID', '稼働マーク(OCR)', '突合']
    },
    {
      name: SHEET_DRIVER,
